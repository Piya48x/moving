    ...
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.container}>
        ...
        <View style={styles.buttonsContainer}>
          <TouchableOpacity style={[styles.button, styles.customerButton]} onPress={handleCustomerPress}>
            <Text style={[styles.buttonText, styles.customerButtonText]}>ลูกค้าทั่วไป</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.button, styles.serviceProviderButton]} onPress={handleServiceProviderPress}>
            <Text style={[styles.buttonText, styles.serviceProviderButtonText]}>ผู้ให้บริการ</Text>
          </TouchableOpacity>
        </View>
